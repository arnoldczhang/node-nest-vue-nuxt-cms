export default {
  route: {
    ...
    // home
    home: '首页',
    bannerManagement: '焦点图管理',
    aboutManagement: '企业特色管理',
    bannerCreate: '添加焦点图',
    bannerUpdate: '更新焦点图',
    homeAboutCreate: '添加首页公司简介',
    homeAboutUpdate: '更新首页公司简介',
    ...
    aboutCreate: '添加',
    aboutUpdate: '更新',
    aboutListManagement: '列表管理',
    aboutCategoryCreate: '添加分类',
    aboutCategoryUpdate: '更新分类',

    // 产品
    product: '产品列表',
    productListManagement: '产品管理',
    productCreate: '产品添加',
    productUpdate: '产品更新',
    productCategoryCreate: '添加产品分类',
